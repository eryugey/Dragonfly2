...
var file_pkg_rpc_scheduler_scheduler_proto_rawDesc = []byte{
	...
	0x06, 0x70, 0x65, 0x65, 0x72, 0x49, 0x64, 0x22, 0x37, 0x0a, 0x13, 0x53, 0x74, 0x61, 0x74, 0x50,
	0x65, 0x65, 0x72, 0x54, 0x61, 0x73, 0x6b, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x20,
	0x0a, 0x07, 0x74, 0x61, 0x73, 0x6b, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x42,
	0x07, 0xfa, 0x42, 0x04, 0x72, 0x02, 0x10, 0x01, 0x52, 0x06, 0x74, 0x61, 0x73, 0x6b, 0x49, 0x64,
	0x32, 0xe1, 0x02, 0x0a, 0x09, 0x53, 0x63, 0x68, 0x65, 0x64, 0x75, 0x6c, 0x65, 0x72, 0x12, 0x49,
	...
	0x12, 0x42, 0x0a, 0x0c, 0x53, 0x74, 0x61, 0x74, 0x50, 0x65, 0x65, 0x72, 0x54, 0x61, 0x73, 0x6b,
	0x12, 0x1e, 0x2e, 0x73, 0x63, 0x68, 0x65, 0x64, 0x75, 0x6c, 0x65, 0x72, 0x2e, 0x53, 0x74, 0x61,
	0x74, 0x50, 0x65, 0x65, 0x72, 0x54, 0x61, 0x73, 0x6b, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74,
	0x1a, 0x12, 0x2e, 0x62, 0x61, 0x73, 0x65, 0x2e, 0x47, 0x72, 0x70, 0x63, 0x44, 0x66, 0x52, 0x65,
	0x73, 0x75, 0x6c, 0x74, 0x42, 0x27, 0x5a, 0x25, 0x64, 0x37, 0x79, 0x2e, 0x69, 0x6f, 0x2f, 0x64,
	0x72, 0x61, 0x67, 0x6f, 0x6e, 0x66, 0x6c, 0x79, 0x2f, 0x76, 0x32, 0x2f, 0x70, 0x6b, 0x67, 0x2f,
	0x72, 0x70, 0x63, 0x2f, 0x73, 0x63, 0x68, 0x65, 0x64, 0x75, 0x6c, 0x65, 0x72, 0x62, 0x06, 0x70,
...
var file_pkg_rpc_scheduler_scheduler_proto_msgTypes = make([]protoimpl.MessageInfo, 10)
var file_pkg_rpc_scheduler_scheduler_proto_goTypes = []interface{}{
	...
	(*PeerPacket_DestPeer)(nil), // 9: scheduler.PeerPacket.DestPeer
	(*base.UrlMeta)(nil),        // 10: base.UrlMeta
	(*base.HostLoad)(nil),       // 11: base.HostLoad
	(base.SizeScope)(0),         // 12: base.SizeScope
	(*base.PieceInfo)(nil),      // 13: base.PieceInfo
	(base.Code)(0),              // 14: base.Code
	(*emptypb.Empty)(nil),       // 15: google.protobuf.Empty
	(*base.GrpcDfResult)(nil),   // 16: base.GrpcDfResult
}
var file_pkg_rpc_scheduler_scheduler_proto_depIdxs = []int32{
	10, // 0: scheduler.PeerTaskRequest.url_meta:type_name -> base.UrlMeta
	3,  // 1: scheduler.PeerTaskRequest.peer_host:type_name -> scheduler.PeerHost
	11, // 2: scheduler.PeerTaskRequest.host_load:type_name -> base.HostLoad
	12, // 3: scheduler.RegisterResult.size_scope:type_name -> base.SizeScope
	2,  // 4: scheduler.RegisterResult.single_piece:type_name -> scheduler.SinglePiece
	13, // 5: scheduler.SinglePiece.piece_info:type_name -> base.PieceInfo
	13, // 6: scheduler.PieceResult.piece_info:type_name -> base.PieceInfo
	14, // 7: scheduler.PieceResult.code:type_name -> base.Code
	11, // 8: scheduler.PieceResult.host_load:type_name -> base.HostLoad
	9,  // 9: scheduler.PeerPacket.main_peer:type_name -> scheduler.PeerPacket.DestPeer
	9,  // 10: scheduler.PeerPacket.steal_peers:type_name -> scheduler.PeerPacket.DestPeer
	14, // 11: scheduler.PeerPacket.code:type_name -> base.Code
	...
	8,  // 17: scheduler.Scheduler.StatPeerTask:input_type -> scheduler.StatPeerTaskRequest
	...
	16, // 22: scheduler.Scheduler.StatPeerTask:output_type -> base.GrpcDfResult
